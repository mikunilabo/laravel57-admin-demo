...
@section('content')
  <main class="main">
    @breadcrumb (['lists' => ['Components' => null, 'Base' => null, 'Collapse' => route('components.base.collapse')]])
    @endbreadcrumb
            ...
            <div class="card">
              ...
              <div class="card-body">
                <p>
                  ...
                  <button class="btn btn-info" type="button" data-toggle="collapse" data-target=".multi-collapse" aria-expanded="false" aria-controls="multiCollapseExample1 multiCollapseExample2">Toggle both</button>
                </p>
                <div class="row">
